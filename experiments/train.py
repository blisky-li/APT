...
def parse_args():
    ...
    parser.add_argument('-c', '--cfg', default='baselines/STID/Illness.py', help='training config')
    # parser.add_argument('-c', '--cfg', default='baselines/TimeMixer/ETTh1.py', help='training config')
